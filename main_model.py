...
#Tahmin icin gerekli feature vektoru olusturma fonksiyonu
def build_feature_vector(df, product_id, customer_id, order_date):
    ...
    # stock * reorder_level etkileşimi — stok bilgilerini otomatik al
    try:
    ...
    # Özellik vektörü — sadece `feature_cols`’a göre
    features = {
...
#Tahmin fonksiyonu
def model_predict(product_id, customer_id, order_date):
